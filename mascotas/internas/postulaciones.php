	...
	<main>
		...
		<?php 
			include("../dll/config.php");
		 	...
		 	$miconexion->consulta("
		 		select p.nombres, p.apellidos, p.cedula, m.nombre, m.raza, m.postulaciones 
		 		from personal p 
		 		inner join postula pl on p.id = pl.personal_id
		 		inner join mascota m on pl.mascota_id = m.id
		 		");
		 	$miconexion->verPostulaciones();
		?>
